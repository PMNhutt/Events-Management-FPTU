 ...
 * @author WilliamTrung
 */
@WebServlet(name = "RemoveLocationController", urlPatterns = {"/RemoveLocationController"})
public class RemoveLocationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            LocationDTO location = new LocationDTO(locationId, 0, null);
            LocationDAO lDao = new LocationDAO();
            boolean check = lDao.removeLocation(location);
            if (check) {
                url = SUCCESS;
            }
        } catch (Exception e) {
