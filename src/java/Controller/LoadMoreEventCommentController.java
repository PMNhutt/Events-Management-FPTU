 ...
 * @author SE151264
 */
public class LoadMoreEventCommentController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(countListCmt>=10 && countListCmt<cdao.countEventComment(eventId)){
                indexCmt=countListCmt/10+1;
                session.setAttribute("END_OF_COMMENT", true);
            }else if(countListCmt==cdao.countEventComment(eventId)){
