...
<html>
    ...
    <body>
        ...
        <p class="errorrr">${requestScope.LOGIN_ERROR}</p>  
        <div id ="footer">
            <div class ="info">
                <ul>
        ...
        <script>
            var getString = document.getElementsByClassName('errorrr');
            if(getString[0].innerHTML !== ""){
                getString[0].style.display = "block";
            }else{
                getString[0].style.display = "none";
            }
        </script>
    </body>
</html>